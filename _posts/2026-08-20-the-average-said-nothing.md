...
웹 빌드를 최적화해 달라는 요청을 받았어요. 목표는 끊김 없는 플레이고, 조건이 세 가지 붙어
있었습니다. 새 소리가 나거나 처음 보는 것이 나타날 때 특히 심하다는 것, 데스크톱보다 웹이
유독 나쁘다는 것, 그리고 **화면 품질은 데스크톱과 달라도 된다**는 것이었어요. 마지막
조건이 해상도를 깎는 선택지를 열어 줍니다.
